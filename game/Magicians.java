...
public abstract class Magicians extends Unit {
    ...
    public Magicians(String name, int strength, int speed, int sleight, int stamina, int determination, int defense, int vulnerability, int damage, int mana, int knowledge){
